...
The suite contains 555 tests across six Vitest files, plus `tsc --noEmit` type checking. There is no build; tests execute the same TypeScript sources that omp loads.
